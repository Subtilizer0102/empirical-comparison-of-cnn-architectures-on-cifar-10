...
of the architectures, various hyperparameters were tuned to achieve maximum performance. The reported
results include the training, testing and validation accuracies along with the trend of losses with respect to
number of epochs the model has run.
